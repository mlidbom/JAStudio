...
class MediaImportPlan:
    ...
    @staticmethod
    def From(scans: IEnumerable_1[NoteMediaFieldScan]) -> MediaImportPlan: ...
...
class NoteMediaFieldScanner:
    ...
    def ScanSentences(self, notes: IReadOnlyList_1[SentenceNote]) -> List_1[NoteMediaFieldScan]: ...
    def ScanVocab(self, notes: IReadOnlyList_1[VocabNote]) -> List_1[NoteMediaFieldScan]: ...
