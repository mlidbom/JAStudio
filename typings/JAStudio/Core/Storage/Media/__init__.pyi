...
class MediaImportAnalyzer:
    ...
    def AnalyzeAnkiKanji(self, notes: IReadOnlyList_1[AnkiKanjiNote], rules: IReadOnlyList_1[KanjiImportRule]) -> MediaImportPlan: ...
    def AnalyzeAnkiSentences(self, notes: IReadOnlyList_1[AnkiSentenceNote], rules: IReadOnlyList_1[SentenceImportRule]) -> MediaImportPlan: ...
    def AnalyzeAnkiVocab(self, notes: IReadOnlyList_1[AnkiVocabNote], rules: IReadOnlyList_1[VocabImportRule]) -> MediaImportPlan: ...
